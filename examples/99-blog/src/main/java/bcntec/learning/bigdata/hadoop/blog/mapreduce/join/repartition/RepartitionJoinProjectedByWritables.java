package bcntec.learning.bigdata.hadoop.blog.mapreduce.join.repartition;

import bcntec.learning.bigdata.hadoop.blog.data.writable.DonationWritable;
import bcntec.learning.bigdata.hadoop.blog.data.writable.ProjectWritable;
import bcntec.learning.bigdata.hadoop.blog.mapreduce.join.replicated.ReplicatedJoinBasic;
...
import org.apache.hadoopuce.lib.input.MultipleInputs;
